...
const registerUser = asyncHandler(async (req, res) => {
  ...
  //validation
  //check if user already existed using username or email
...
const loginUser = asyncHandler(async (req, res) => {
  // req body se data
  //username email available or not
  //find the user
  //password check
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Avatar image is changed"));
});
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200,user,"Cover Image image is changed"))
});
export {
  registerUser,
  loginUser,
